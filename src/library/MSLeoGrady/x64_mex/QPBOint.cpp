...
const int QPBO::NODEPTR_BLOCK_SIZE = 128;
...
bool QPBO::Load(char* filename)
{
	...
	if (strcmp(LINE, type_name)) { printf("%s: type int mismatch\n", filename); fclose(fp); return false; }
...
QPBO::EdgeId QPBO::AddPairwiseTerm(NodeId _i, NodeId _j, int E00, int E01, int E10, int E11)
{
...
void QPBO::AddPairwiseTerm(EdgeId e, NodeId _i, NodeId _j, int E00, int E01, int E10, int E11)
{
...
int QPBO::ComputeTwiceEnergy(int option)
{
	int E = 2*zero_energy, E1[2], E2[2][2];
	int i, j, e;
	int xi, xj;
...
int QPBO::ComputeTwiceEnergy(int* solution)
{
	int E = 2*zero_energy, E1[2], E2[2][2];
	int i, j, e;
...
int QPBO::ComputeTwiceLowerBound()
{
	int lowerBound = 2*zero_energy, E0, E1, E00, E01, E10, E11;
	int i, j, e;
