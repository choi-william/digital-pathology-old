...
img1 = double(imread('+prepare/+bfilter2/einstein.jpg'))/255;
img2 = double(imread('+prepare/+bfilter2/mandrill.jpg'))/255;
img3 = double(imread('+prepare/+bfilter2/academy.jpg'))/255;
